  ...
  return (
    <div className="relative mx-auto flex w-full max-w-md items-center justify-center">
      ...
      <div className="animate-[float_3.8s_ease-in-out_infinite] rounded-[2.5rem] border border-white/15 bg-[#d9dde6] p-5 shadow-[0_25px_60px_rgba(0,0,0,0.45)]">
        <div className="w-[290px] rounded-[2rem] bg-[#cfd4dc] p-4 shadow-inner">
          ...
          <div className="rounded-[1.5rem] border-4 border-[#5f6877] bg-[#a8d5c2] p-3">
            <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden rounded-[1rem] bg-[#87c0a8]">
              <div className="absolute inset-0 bg-[linear-gradient(to_bottom,transparent_0%,rgba(255,255,255,0.08)_50%,transparent_100%)] bg-[length:100%_8px] opacity-50" />
